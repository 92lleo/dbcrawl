...
public class StringSimilarity {
	 ...
	 * @return levenstein distance s1&s2 as double percentage, -1 if s1 or s2 is empty
	 */
    ...
    public void output(final String a, final String b) {
        System.out.println("Übereinstimmung von <" + a + ">, <" + b + ">: " + getStringAccordance(a, b) + "%");
    }
}
